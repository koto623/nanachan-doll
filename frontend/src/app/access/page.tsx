...
export default function Home() {
  const images = [
    { src: '/images/facility01.jpg', alt: 'facility01' },
    ...
    <div className="container">
      ...
      <main className="content">
        ...
        <section className="access">
          <h2>アクセス</h2>
          <img src="/images/map.png" alt="ナナちゃん人形周辺のマップ" className="map-image" />
